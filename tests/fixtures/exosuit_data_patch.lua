...
return function(api,game,baseline,code_guard)
    ...
    local targets={[26]=true,[10]=true,[89]=true,[86]=true}
    ...
    assert(#code_guard==224 and api.read(game+0x11cce65,224)==code_guard,'selection_code_not_original')
    ...
    assert(pos==size and total==147 and #changes==4,'incomplete_settings')
    ...
    local ok,err=pcall(function()
        ...
        assert(api.read(game+0x11cce65,224)==code_guard,'selection_code_changed')
    end)
