...
return function(api,game,baseline,code_guard)
    ...
    local targets={[105]=0x20,[26]=0x20,[135]=0x20}
    ...
    assert(#code_guard==724 and api.read(game+0x146e27d,724)==code_guard,'selection_code_not_original')
    ...
    assert(pos==size and total==149 and #changes==3,'incomplete_settings')
    ...
    local ok,err=pcall(function()
        ...
        assert(api.read(game+0x146e27d,724)==code_guard,'selection_code_changed')
    end)
